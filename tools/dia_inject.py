...
if "--start" in sys.argv:
    ...
    js("""(function(){var c=__swiper.cfg; c.vision.provider='bridge'; c.vision.geminiKey=%s; c.vision.key=%s; c.vision.geminiModel='gemini-3.5-flash-lite, gemini-3.1-flash-lite'; c.vision.onFail='wait'; c.vision.proxy='http://127.0.0.1:8802/img?u='; c.vision.enabled=true;
      c.speed=1; c.likeRatio=0; c.vision.likeBodies='slim, athletic'; c.vision.likeMinQuality=7; c.vision.curvesAutoLike=7; c.vision.bustAutoLike=7; c.vision.sexyAutoLike=7; c.vision.unsure='nope'; c.vision.requireFullBody=true; c.vision.maxPhotos=9; c.photosToView=[2,3]; c.vision.minFace=6; c.vision.likeFace=7; c.vision.nopePiercings=true; c.vision.nopeAlt=true; c.vision.nopeDyedHair=true; c.filters.nopeWords='liberal, leftist, feminist, socialist, communist, progressive, antifa, acab, blm, black lives matter, lgbtq, lgbtqia, pro-choice, pro choice, they/them, she/they, nonbinary, non-binary, free palestine'; c.maxPerSession=100000; c.maxPerDay=100000; c.breakEvery=[100000,100001]; c.hours.enabled=false;
